...
abstract contract ERC404 is IERC404 {
    ...
    //! 此 Function 主要處理在轉移 ERC20 可能會遇到的 ERC721 的部分（燒毀/合併）
    function _transferERC20WithERC721(
        ...
        //! 下方全是處理有關 ERC721 的部分，判斷的地方主要是有關豁免的邏輯處理
        ...
        if (isFromERC721TransferExempt && isToERC721TransferExempt) {
            ...
            //! 發送的 ERC20 剛好可以轉換成整數的 ERC721，那麼就直接傳送 ERC721
            ...
            //! 如果發送方因為發送的 ERC20 而應該少一個 ERC721，那麼就會從接受方取出一個 ERC721 放入 bank 中
            if (
            ...
            //! 如果接受方因為接收的 ERC20 而應該多一個 ERC721，那麼就會從 bank 中取出一個 ERC721
            if (
                erc20BalanceOf(to_) /
                    units -
    ...
    function _afterERC721Mint(uint256 id_) internal virtual {}
    ...
    function _retrieveOrMintERC721(address to_) internal virtual {
        ...
        //! 裡面有一個 bank 的概念，如果 bank 有 ERC721，那麼就從 bank 中取出一個 ERC721
        //! 反之，若沒有就 mint 一個新的 ERC721，且 id 是累加上去的
